...
DEFAULT_SETTINGS: dict[str, Any] = {
    ...
    "daily_report_title": "昨日久坐小结 · {yesterday_date}",
    "daily_report_body": "昨天累计坐姿 {yesterday_total}，共 {yesterday_sessions} 次，久坐 {yesterday_sedentary} 次，最长连续 {yesterday_longest}。",
    "weekly_report_enabled": 1,
    "weekly_report_day": 7,
    "weekly_report_time": "20:35",
    "weekly_report_title": "本周久坐报告 · {week_start}–{week_end}",
    "weekly_report_body": "本周累计坐姿 {week_total}，日均 {week_daily_average}，共 {week_sessions} 次，久坐 {week_sedentary} 次，最长连续 {week_longest}。",
    "bark_enabled": 0,
    "webhook_enabled": 0,
        ...
        with self.connect() as db:
            ...
            db.executescript(
                ...
                CREATE TABLE IF NOT EXISTS settings (
                    ...
                    daily_report_title TEXT NOT NULL,
                    daily_report_body TEXT NOT NULL,
                    ...
                    weekly_report_title TEXT NOT NULL,
                    weekly_report_body TEXT NOT NULL,
            ...
            migrations = {
                ...
                "daily_report_title": "ALTER TABLE settings ADD COLUMN daily_report_title TEXT NOT NULL DEFAULT '昨日久坐小结 · {yesterday_date}'",
